...
const ::uint32_t
    TableStruct_hello_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::greeting::HelloRequest, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::greeting::HelloRequest, _impl_.name_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::greeting::HelloReply, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::greeting::HelloReply, _impl_.message_),
};

static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::greeting::HelloRequest)},
        {9, -1, -1, sizeof(::greeting::HelloReply)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::greeting::_HelloRequest_default_instance_._instance,
    &::greeting::_HelloReply_default_instance_._instance,
};
const char descriptor_table_protodef_hello_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\013hello.proto\022\010greeting\"\034\n\014HelloRequest\022"
    "\014\n\004name\030\001 \001(\t\"\035\n\nHelloReply\022\017\n\007message\030\001"
    " \001(\t2\214\001\n\007Greeter\022:\n\010SayHello\022\026.greeting."
    "HelloRequest\032\024.greeting.HelloReply\"\000\022E\n\021"
    "SayHelloAndListen\022\026.greeting.HelloReques"
    "t\032\024.greeting.HelloReply\"\0000\001b\006proto3"
};
...
HelloRequest::HelloRequest(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:greeting.HelloRequest)
}
...
HelloRequest::HelloRequest(
  ...
  // @@protoc_insertion_point(copy_constructor:greeting.HelloRequest)
}
inline PROTOBUF_NDEBUG_INLINE HelloRequest::Impl_::Impl_(
...
HelloRequest::~HelloRequest() {
  // @@protoc_insertion_point(destructor:greeting.HelloRequest)
...
// @@protoc_insertion_point(message_clear_start:greeting.HelloRequest)
...
const ::_pbi::TcParseTable<0, 1, 0, 34, 2> HelloRequest::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::greeting::HelloRequest>(),  // to_prefetch
...
::uint8_t* HelloRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:greeting.HelloRequest)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (!this->_internal_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "greeting.HelloRequest.name");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:greeting.HelloRequest)
  return target;
}

::size_t HelloRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:greeting.HelloRequest)
  ::size_t total_size = 0;
...
void HelloRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:greeting.HelloRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:greeting.HelloRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::google::protobuf::Metadata HelloRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(&descriptor_table_hello_2eproto_getter,
                                   &descriptor_table_hello_2eproto_once,
...
HelloReply::HelloReply(::google::protobuf::Arena* arena)
    : ::google::protobuf::Message(arena) {
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:greeting.HelloReply)
}
...
HelloReply::HelloReply(
  ...
  // @@protoc_insertion_point(copy_constructor:greeting.HelloReply)
}
inline PROTOBUF_NDEBUG_INLINE HelloReply::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
HelloReply::~HelloReply() {
  // @@protoc_insertion_point(destructor:greeting.HelloReply)
  _internal_metadata_.Delete<::google::protobuf::UnknownFieldSet>();
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:greeting.HelloReply)
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const ::_pbi::TcParseTable<0, 1, 0, 35, 2> HelloReply::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::greeting::HelloReply>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // string message = 1;
    {::_pbi::TcParser::FastUS1,
...
::uint8_t* HelloReply::_InternalSerialize(
    ::uint8_t* target,
    ::google::protobuf::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:greeting.HelloReply)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (!this->_internal_message().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "greeting.HelloReply.message");
    target = stream->WriteStringMaybeAliased(1, _s, target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:greeting.HelloReply)
  return target;
}

::size_t HelloReply::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:greeting.HelloReply)
  ::size_t total_size = 0;
...
void HelloReply::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:greeting.HelloReply)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:greeting.HelloReply)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
